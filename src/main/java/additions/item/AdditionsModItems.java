...
public class AdditionsModItems {
   public static final Item EDIBLE_FISH = new Item(new FabricItemSettings().group(ItemGroup.FOOD).food(FoodComponents.ROTTEN_FLESH)); // TODO - Create custom food component in future?
