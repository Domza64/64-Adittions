...
import additions.item.items.OxygenMonitor;
...
public class AdditionsModItems {
    ...
    public static final Item OXYGEN_MONITOR = new OxygenMonitor();
    ...
    public static void registerItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier(AdditionsMod.MOD_ID, "oxygen_monitor"), OXYGEN_MONITOR);
    }
}
